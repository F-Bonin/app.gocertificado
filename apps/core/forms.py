...
class CourseForm(forms.ModelForm):
    ...
    class Meta:
        model = Course
        fields = [
            "name", "event_format", "platform_name", "platform_link",
            "start_date", "end_date", "hours",
            "location_type", "condominium_name", "cep", "institution_name", 
            "institution_street", "institution_number", "address_block", 
            "address_floor", "address_apt", "institution_neighborhood", 
            "institution_complement", "state", "city",
            "registration_start", "registration_end",
            "certificate_start", "certificate_end", "no_certificate",
            "signature_1", "signature_2", "signature_3",
            "certificate_template", "nps_form", "custom_reg_form", "custom_cert_form"
        ]
        labels = {
            "name": "Nome do Evento",
            "custom_reg_form": "Formulário de Inscrição",
            "custom_cert_form": "Formulário de Solicitação de Certificado",
            "institution_name": "Nome do Local",
        }
        widgets = {
            "name": forms.TextInput(attrs={"class": "form-control"}),
            "event_format": forms.RadioSelect(attrs={'class': 'form-check-input'}),
            ...
            "location_type": forms.RadioSelect(attrs={'class': 'form-check-input'}),
            ...
            "city": forms.TextInput(attrs={"class": "form-control", "id": "id_course_city", "list": "cidadesList", "placeholder": "Ex: São Paulo"}),
            "state": forms.TextInput(attrs={"class": "form-control", "id": "id_course_state", "list": "estadosList", "placeholder": "Ex: SP"}),
            "hours": forms.TextInput(attrs={"class": "form-control", "list": "hoursList", "placeholder": "Ex: 10h, 00:30min..."}),
...
class EventSessionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'hours': forms.TextInput(attrs={'class': 'form-control', 'readonly': True}),
